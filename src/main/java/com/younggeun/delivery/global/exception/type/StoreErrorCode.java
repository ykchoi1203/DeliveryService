...
public enum StoreErrorCode implements ErrorCode {
  ...
  STORE_DOCUMENT_NOT_FOUND(HttpStatus.BAD_REQUEST, "해당 가게를 elasticsearch에서 찾을 수 없습니다."),
  ...
  STORE_NOT_ACCESS(HttpStatus.BAD_REQUEST, "해당 가게는 허가되지 않았습니다."),
  ...
  CANNOT_CLOSE_STORE_BECAUSE_ORDER_STATUS(HttpStatus.BAD_REQUEST, "가게를 닫을 수 없습니다. 완료되지 않은 주문이 존재합니다."),
  STORE_ACCESS_STATUS_IS_SAME(HttpStatus.BAD_REQUEST, "바꾸고자 하는 상태와 가게 허가 생태가 동일합니다.");
